        ...
        <div className="lg:w-1/2">
          <div className="md:space-y-2">
            ...
            <h3
              ...
              className="text-2xl md:text-3xl lg:text-4xl font-semibold pt-1 md:pt-0"
            >
            ...
            <p
              ...
              className="text-textColor text-sm md:text-base xl:w-3/4 pt-2"
            >
          ...
          <div className="w-full pt-6 md:pt-10 flex gap-4">
            <div
              data-aos="zoom-in"
              data-aos-duration={1200}
              className="w-[12%] h-full hidden md:flex items-center justify-center"
            >
              <div>
            ...
            <div className="w-full flex flex-col gap-5 md:gap-10 lg:gap-8">
              <div className="flex flex-col gap-1 md:gap-2">
                ...
                <p
                  data-aos="fade-left"
                  data-aos-duration={1300}
                  className="text-textColor text-sm md:text-base xl:w-3/4"
                >
